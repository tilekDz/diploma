...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.
                ...
                .antMatchers("/login", "/createReport", "/createReportWord/**", "/static/**", "/getStockPage", "/searchStock/", "/userPage", "/js/**", "/image/**",  "/getHardware/**", "/getStock/**","/addToHardware/**", "/saveToHardware" ,"/addStock").permitAll()
                .anyRequest()
                .authenticated()
                .and().csrf().disable()
